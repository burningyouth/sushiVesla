...
function NavbarView() {
  return (
    <header>
      <div className="navbar navbar_static">
        <div className="navbar__content-wrapper container container_fluid">
          <div className="navbar__content">
            ...
            <a className="logo hide-xl" href="/">
              <img src="assets/img/logo.png" alt="logo" />
            </a>
            <a className="logo logo_phone show-xl hide-md" href="/">
              <img src="assets/img/logo-phone.png" alt="logo" />
            </a>
            <ul className="navbar__user-info ml-md-30 ml-10">
              ...
              <li className="navbar__item ml-15 hide-md">
                <a href="tel:88005503030" className="link">
                  8-800-550-30-30
                </a>
              </li>
              <li className="navbar__item navbar__item_user hide-md">
                <a href="/" className="link link_bold">
                  Личный кабинет
          ...
          <div className="navbar__content navbar__content_right">
            <div className="navbar__content mr-30">
              <ul className="navbar__items" id="navbar__items">
                <li className="navbar__item">
